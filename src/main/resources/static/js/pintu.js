...
// function startTimer() {
//     var startTime = new Date().getTime(); // 获取当前时间，单位毫秒
//     timer = setInterval(function() {
//         var currentTime = new Date().getTime(); // 获取当前时间，单位毫秒
//         var elapsedTime = currentTime - startTime; // 计算经过的时间，单位毫秒
//         var seconds = Math.floor(elapsedTime / 1000); // 将毫秒转换为秒，向下取整
//         var minutes = Math.floor(seconds / 60); // 将秒转换为分钟，向下取整
//         seconds = seconds % 60; // 计算剩余的秒数
//         var timerDisplay = document.getElementById("time"); // 获取显示时间的元素
//         timeHours = minutes + ":" + (seconds < 10 ? "0" + seconds : seconds);
//         timerDisplay.innerHTML = "用时:"+ timeHours;// 更新显示时间
//     }, 1000); // 每隔1秒钟更新一次时间
// }
