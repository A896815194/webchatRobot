...
import com.web.webchat.util.Base64Util;
...
public class AsrMain {
    ...
    private final String APP_KEY = "a7MATvvC5UQAXwlfURQR1WV3";

    // 填写网页上申请的APP SECRET 如 $SECRET_KEY="94dc99566550d87f8fa8ece112xxxxx"
    private final String SECRET_KEY = "a865cb705181ccfca40915a5db70fbd4";

    // 需要识别的文件
    private final String FILENAME = "G:\\test\\pcm\\16k_10.pcm";
